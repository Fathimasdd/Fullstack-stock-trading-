    ...
    return ( <div className='container'>
        <div className='row p-5 mt-5 mb-5'>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className='' > <i class="fa fa-plus" aria-hidden="true"></i> Account Opening</h4>
                ...
                <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Company ,Patnership and HUF Account </a><br/>
                <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}> Opening</a><br/>
                <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Charges at Ferodha</a><br/>
                <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Ferodha IDFC FIRST Bank 3-in-1 Account</a><br/>
                <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}> Getting started</a><br/>
            </div>
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className='' > <i class="fa fa-user" aria-hidden="true"></i> Your Ferodha Account</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className='' > <i class="fa fa-users" aria-hidden="true"></i> Console</h4>
            ...
            <div className='col-4 p-5 mt-2 mb-2'>
                <h4 className='' > <i class="fa fa-money" aria-hidden="true"></i> Coin</h4>
