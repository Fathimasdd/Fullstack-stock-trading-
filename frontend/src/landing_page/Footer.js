    ...
    return (
        ...
        <div className='container border-top mt-5' >
            <div className='row mt-5'>
                <div className='col'>
                    <img src='media/images/ferodhaa.png' style={{width:"50%"}}/>
                    <p>&copy; 2010-2025 ,Not Ferodha Broking Ltd.All rights reserved.</p>
                </div>
                <div className='col-3'>
                    <p>Company</p>
                    ...
                    <br/>
                    <a href='' style={{textDecoration:"none"}}>Ferodha.tech</a>
                    <br/>
                    <a href='' style={{textDecoration:"none"}}>Press & media</a>
                    <br/>
                    <a href='' style={{textDecoration:"none"}}>Ferodha cares</a>
                </div>
                <div className='col-3'>
                    <p>Support</p>
                    ...
                    <br/>
                    <a href='' style={{textDecoration:"none"}}>F-Connect blog</a>
                    <br/>
